...
#
# === HubMax Notes ===
# This file is copied from the official Supabase repo (supabase/supabase/docker/volumes/api/)
# It replaces the old `bash -c eval "echo \"$(cat ~/temp.yml)\""` entrypoint from Kong 2.8.
#
# When SUPABASE_SECRET_KEY and SUPABASE_PUBLISHABLE_KEY are EMPTY (legacy mode),
# the expressions simply pass through apikey/authorization headers as-is.
# This is the HubMax default — we still use symmetric HS256 JWTs.
